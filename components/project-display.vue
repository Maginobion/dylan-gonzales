...
const data = [
  {
    ...
    stack: ["vue", "tailwind"] as AvailableTech[],
  ...
  },
  {
    ...
    stack: ["react", "next", "tailwind"] as AvailableTech[],
    repo: "",
    live: "",
  },
  {
    ...
    stack: ["react", "jest", "rtl", "tailwind"] as AvailableTech[],
  ...
  },
  {
    ...
    img: "/portfolio.webp",
    alt: "Medical web platform",
    stack: ["vue", "nuxt"] as AvailableTech[],
  ...
  },
  {
    ...
    img: "/portfolio.webp",
    alt: "Medical web platform",
    stack: ["vue", "laravel"] as AvailableTech[],
...
.content {
  ...
  overflow: hidden;
  width: 400px;
  transition: var(--duration) margin-left ease-in-out,
    var(--duration) height ease-in-out;
}
.wholeContent {
  transition: var(--duration) margin-left ease-in-out,
    var(--duration) height ease-in-out;
